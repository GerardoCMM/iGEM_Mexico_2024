...
pathway = ["Pn8.2617", "Pn2.84", "Pn1.1317", "Pn7.1626", "Pn16.1198", "Pn4.3222", "Pn2.2377", "Pn6.2477","Pn3.4770", "Pn16.1237", "Pn12.1813"]
...
with open('gene_names.txt', 'w') as f:
    ...
    for gene in pathway:
        for i,genename in enumerate(list(pos.loc[:,"name"])):
            if gene==genename:
                print(f"{pos.loc[i,'Chromosome']}\t{int(pos.loc[i,'init'])}\t{int(pos.loc[i,'end'])}\t{genename}")
    sys.stdout = original_stdout # Reset the standard output to its original value


p_1 = ["Pn18.38","Pn8.311","Pn8.2617","Pn38.78","Pn2.1585","Pn18.31","Pn2.1119","Pn60.17","Pn6.2504","Pn28.318","Pn60.20",
...
p_3 = ["Pn17.1666","Pn17.1664","Pn17.1665","Pn17.1667","Pn1.1321","Pn15.789","Pn17.1669","Pn17.1725","Pn17.1670",
"Pn1.1313","Pn1.1319","Pn23.369","Pn17.1671","Pn17.1661","Pn19.1110","Pn8.263","Pn23.375","Pn17.1724","Pn1.1317",
"Pn17.1662","Pn1.1318","Pn17.1668","Pn17.1723","Pn19.1109","Pn17.1663","Pn17.1051"]

p_4 = ["Pn4.3099","Pn2.2352","Pn7.1626","Pn3.4771","Pn2.2347","Pn3.4770","Pn3.4772"]

p_5 = ["Pn24.608","Pn16.2101","Pn24.611","Pn3.2552","Pn24.639","Pn16.1236","Pn24.642","Pn3.4306",
...
"Pn16.1198","Pn8.2226","Pn10.216","Pn36.23","Pn36.25","Pn12.2017","Pn8.2219","Pn16.182","Pn15.1623",
"Pn15.1620","Pn26.649","Pn26.648","Pn1.2579","Pn1.2585"]

p_6 = ["Pn15.99","Pn11.1118","Pn11.2681","Pn26.157","Pn30.345","Pn51.76","Pn30.381","Pn11.2682",
"Pn5.2063","Pn14.81","Pn13.2002","Pn2.2494","Pn8.236","Pn2.2647","Pn2.2654","Pn1.1880","Pn6.2605",
"Pn7.1523","Pn2.2577","Pn2.2669","Pn22.746","Pn4.3222","Pn6.2582","PN41.1","Pn2.2581","Pn22.747",
"Pn22.492","Pn2.2652","Pn2.2656","Pn2.2671"]

p_7 = ["Pn1.1024","Pn1.1022","Pn1.1012","Pn1.994","Pn15.572","Pn24.75","Pn1.988","Pn1.977","Pn23.264","Pn1.1001",
...
"Pn23.267","Pn1.1021","Pn11.942","Pn16.1933","Pn1.1005","Pn1.1023","Pn1.1011","Pn1.995","Pn2.2377","Pn1.970",
...
p_8 = ["Pn1.2478","Pn3.1635","Pn8.2854","Pn6.1174","Pn40.54","Pn40.58","Pn5.218","Pn17.454","Pn40.52","Pn5.221",
...
"Pn55.27","Pn10.921","Pn12.1192","Pn17.1283","Pn2.2391","Pn15.26","Pn6.2477","Pn10.919","Pn1.3375","Pn15.421",
...
for i,enzyme in enumerate(enzymes):
    with open(f'p_{i+1}.txt', 'w') as f:
        sys.stdout = f # Change the standard output to the file we created.
        for gene in enzyme:
            for j,genename in enumerate(list(pos.loc[:,"name"])):
                if gene==genename:
                    print(f"{pos.loc[j,'Chromosome']}\t{int(pos.loc[j,'init'])}\t{int(pos.loc[j,'end'])}")
        sys.stdout = original_stdout # Reset the standard output to its original value